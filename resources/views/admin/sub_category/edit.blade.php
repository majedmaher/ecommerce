    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('sub_category.update') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control @error('sub_category_name_en') is-invalid @enderror" name="sub_category_name_en" value="{{$sub_category->sub_category_name_en}}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control @error('sub_category_name_ar') is-invalid @enderror" name="sub_category_name_ar" value="{{$sub_category->sub_category_name_ar}}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <label class="custom-file">
                                    <input type="file" name="sub_category_image" class="custom-file-input" onChange="mainThamUrl(this)">
                                ...
                                @enderror
                                <img src="{{asset($sub_category->sub_category_image)}}" id="sub_category_image">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="category_id" class="form-control select2-show-search" data-placeholder="Choose one (with searchbox)">
                                    ...
                                    <option {{$category->id == $sub_category->category_id ? 'selected':'' }} value="{{$category->id}}">{{$category->category_name_en}}</option>
                                    @endforeach
                                </select>
                                @error('category_id')
                                <span class="invalid-feedback alert-invalid" role="alert">
